...
export class ReportDetailsDialog {
  ...
  onViewReportedEntity() {
    if (this.data.report.reportedUser) {
      this.router.navigate(['/profile', this.data.report.reportedUser.username]);
      this.dialogRef.close();
    } else if (this.data.report.reportedPost) {
      this.router.navigate(['/posts', this.data.report.reportedPost.id]);
      this.dialogRef.close();
    }
  }

  onViewReporter() {
    this.router.navigate(['/profile', this.data.report.reporter.username]);
    this.dialogRef.close();
  }
